...
export default function Profile() {
  ...
  const dummyOverview: ProfileOverview = {
  user: {
    name: "Knut Olsen",
    nickName: "MiljøKnut",
  ...
  totalCo2Savings: 32.8,
  totalTravels: 56,
  totalMoneySaved: 742,
  completedChallenges: 9,
  achievements: [
    // Walking
    { achievementId: 1, name: "Turgåer", description: "Gå totalt 10 km", total: 10, progress: 10, earnedAt: "2024-04-01", tier: 1, isMaxTier: false },
    // Cycling
    { achievementId: 5, name: "Syklist", description: "Sykle totalt 50 km", total: 50, progress: 50, earnedAt: "2024-05-01", tier: 2, isMaxTier: false },
    // Bus
    { achievementId: 7, name: "Bussreisende", description: "Reis 10 km med buss", total: 10, progress: 10, earnedAt: "2024-03-01", tier: 1, isMaxTier: false },
    // Car
    { achievementId: 10, name: "Samkjører", description: "Kjør 10 km med bil", total: 10, progress: 10, earnedAt: "2024-05-03", tier: 1, isMaxTier: false },
    // Entries
    { achievementId: 14, name: "Utforsker", description: "Registrer 20 reiser totalt", total: 20, progress: 20, earnedAt: "2024-03-10", tier: 2, isMaxTier: false },
    // Points
    { achievementId: 21, name: "Poengjeger", description: "Samle 1000 poeng", total: 1000, progress: 7243, earnedAt: "2024-06-10", tier: 3, isMaxTier: true },
    // CO2
    { achievementId: 24, name: "CO₂-sparer", description: "Spar 50 kg CO₂", total: 50, progress: 32.8, earnedAt: null, tier: 3, isMaxTier: true },
    // Money
    { achievementId: 27, name: "Pengebesparer", description: "Spar 500 kroner", total: 500, progress: 742, earnedAt: "2024-05-10", tier: 3, isMaxTier: true },
    // Challenges unlocked
    { achievementId: 30, name: "Opplåser", description: "Lås opp 10 unike utfordringer", total: 10, progress: 9, earnedAt: null, tier: 3, isMaxTier: true },
    // Egen vei
    { achievementId: 17, name: "Egen vei", description: "Fullfør 5 egendefinerte utfordringer", total: 5, progress: 5, earnedAt: "2024-05-10", tier: 3, isMaxTier: true},
  ],
};
